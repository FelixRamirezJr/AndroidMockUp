...
public class NavigationExample extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position)
    {
        ...
        switch(position)
        {
            case 0: objFragment = new Mode1Fragment(); break;
            case 1: objFragment = new Mode2Fragment(); break;
            case 2: objFragment = new Mode3Fragment(); break;
        }
    ...
    public static class PlaceholderFragment extends Fragment
    {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_navigation_example, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((NavigationExample) activity).onSectionAttached(
