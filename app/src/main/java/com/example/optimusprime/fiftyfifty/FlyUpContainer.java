...
/**
 * Created by Optimus Prime on 3/11/2015.
 */
import android.content.Context;
...
public class FlyUpContainer extends LinearLayout {
...
//			new SmoothInterpolator());
    ...
    public FlyUpContainer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FlyUpContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FlyUpContainer(Context context) {
        super(context);
    }
    ...
    protected class AnimationRunnable implements Runnable {
        ...
        public void run() {
            FlyUpContainer.this
                    .adjustContentPosition(FlyUpContainer.this.menuAnimationScroller
                            .computeScrollOffset());
        }
